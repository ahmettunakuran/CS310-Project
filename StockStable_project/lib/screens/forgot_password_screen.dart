...
class _ForgotPasswordScreenState extends State<ForgotPasswordScreen> {
  ...
  void _showInvalidFormDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        backgroundColor:
            _themeManager.isDarkMode ? _themeManager.cardColor : Colors.white,
        title: Text(
          'Invalid Form',
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _buildLabelAndField('NEW PASSWORD', '......',
                  obscure: true,
                  controller: _newPasswordController, validator: (val) {
              ...
              _buildLabelAndField('PASSWORD AGAIN', '......',
                  obscure: true,
                  controller: _confirmPasswordController, validator: (val) {
  ...
  Widget _buildCodeBox() {
    return Container(
      ...
      child: Text('-',
          style:
              TextStyle(fontSize: 24, color: _themeManager.primaryTextColor)),
    );
  }
}
