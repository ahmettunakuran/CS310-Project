  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        // TODO: FURKAN: SettingsScreen.dart oluşturup designladıktna sonra sağdaki navigasyonu buraya yapıştırılıcak -> '/settings': (context) => const SettingsScreen(),
        // TODO: FURKAN: HelpScreen.dart oluşturup designladıktna sonra sağdaki navigasyonu buraya yapıştırılıcak -> '/help': (context) => const HelpScreen(),
